...
public class PersonListPanelTest extends JFCTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        person1 = createPerson("Hallvard TrÃ¦tteberg", "16.nov.1966", Gender.male,
                "hal@idi.ntnu.no", 179);
        person2 = createPerson("Marit Reitan", "17.apr.1964", Gender.female,
                "marit.reitan@idi.ntnu.no", 176);
        person3 = createPerson("Jens Reitan TrÃ¦tteberg", "14.jan.1997",
        		Gender.male, null, 145);
        person4 = createPerson("Anne TrÃ¦tteberg Reitan", "13.jun.1998",
