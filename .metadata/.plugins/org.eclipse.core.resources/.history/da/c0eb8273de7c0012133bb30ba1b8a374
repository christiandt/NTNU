...
public class PersonPanelTest extends JFCTestCase {
    ...
    public static Person createPerson(String name, String dateOfBirth, Gender gender, String email, int height) {
    ...
    protected void setUp() throws Exception {
        ...
        person1 = createPerson("Ola Nordmann", "1.nov.1970", Gender.male, "ola@nordmann.com", 191);
        person2 = createPerson("Kari Nordmann", "7.jul.1971", Gender.female, "kari@nordmann.com", 170);
    ...
    public void testComponentPresence() {
        ...
        JComponent comp = findComponent(JSlider.class, "HeightPropertyComponent", false);
        if (comp == null) {
    ...
    public void testNamePropertyComponent() {
        JTextField nameTextField = (JTextField) findComponent(JTextField.class, "NamePropertyComponent");
    ...
    public void testDateOfBirthPropertyComponent() throws ParseException {
        JTextField dateOfBirthTextField = (JTextField) findComponent(JTextField.class, "DateOfBirthPropertyComponent");
        dateOfBirthTextField.setText("");
        getHelper().sendString(new StringEventData(this, dateOfBirthTextField, person2.getDateOfBirth()));
        getHelper().sendKeyAction(new KeyEventData(this, dateOfBirthTextField, KeyEvent.VK_ENTER));        
    ...
    public void testEmailPropertyComponent() throws ParseException {
        JTextField emailTextField = (JTextField) findComponent(JTextField.class, "EmailPropertyComponent");
